...
void main() {
    ...
    if (t > 0.0) {
        ...
        vec3 wineRed = vec3(0.55, 0.0, 0.1);
        vec3 burgundy = vec3(0.17, 0.0, 0.06);
        vec3 deepRed = vec3(0.8, 0.0, 0.15);
        
        vec3 color = mix(burgundy, wineRed, fresnel);
        color = mix(color, deepRed, smoothstep(0.5, 1.0, fresnel));
...
export default function RedWineFluidBackground() {
    return (
